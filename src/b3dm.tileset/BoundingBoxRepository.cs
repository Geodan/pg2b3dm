...
namespace B3dm.Tileset
{
    public static class BoundingBoxRepository
    {
        ...
        public static List<GeometryRecord> GetGeometrySubset(NpgsqlConnection conn, string geometry_table, string geometry_column, string idcolumn, double[] translation, Tile t, int epsg, string colorColumn = "", string attributesColumn = "", string lodColumn="", string query = "")
        {
            var where = (query != string.Empty ? $"and {query}" : String.Empty);
