...
namespace B3dm.Tileset.Tests
{
    public class BoundingBoxRepositoryTests
    {
        ...
        public void GetBoundingBox3D()
        {
            ...
            var expected = new double[] { 1231256.4091099831, -4800453.896456448, 4000024.663498499, 1244883.5968566877, -4791281.918551793, 4012180.059993551 };
            ...
            Assert.IsTrue(actualTranslation[0]== expectedTranslation[0] &&
                actualTranslation[1] == expectedTranslation[1] &&
                actualTranslation[2] == expectedTranslation[2]);
