...
[System.Diagnostics.DebuggerDisplay("BatchId:{BatchId} UV:{TexCoord}")]
public struct VertexWithBatchIdTexture : IVertexCustom
{
    public VertexWithBatchIdTexture(float batchId, Vector2 texCoord)
    {
        BatchId = batchId;
        TexCoord = texCoord;
    }
