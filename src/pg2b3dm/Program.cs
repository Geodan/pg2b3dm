...
namespace pg2b3dm
{
    class Program
    {
        ...
        private static int WriteTiles(NpgsqlConnection conn, string geometryTable, string geometryColumn, string idcolumn, double[] translation, List<Tile> tiles, int epsg, string outputPath, int counter, int maxcount, string shaderColumn = "", string attributesColumn = "", string lodColumn="")
        {
            foreach (var t in tiles) {
                counter++;
                ...
                var geometries = BoundingBoxRepository.GetGeometrySubset(conn, geometryTable, geometryColumn, idcolumn, translation, t, epsg, shaderColumn, attributesColumn, lodColumn);
                ...
                if (t.Children != null) {
                    counter = WriteTiles(conn, geometryTable, geometryColumn, idcolumn, translation, t.Children, epsg, outputPath, counter, maxcount, shaderColumn, attributesColumn, lodColumn);
                }
