    ...
    static void Main(string[] args)
    {
        ...
        Parser.Default.ParseArguments<Options>(args).WithParsed(o => {
            ...
            if (o.AppMode == AppMode.Cesium) {
                ...
                var quadtreeTiler = new QuadtreeTiler(conn, table, source_epsg, geometryColumn, o.MaxFeaturesPerTile, query, translation, o.ShadersColumn, o.AttributeColumns, lodcolumn, contentDirectory, lods, o.Copyright, skipCreateTiles, o.RadiusColumn, (bool)o.UseImplicitTiling);
